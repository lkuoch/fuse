...
import type { ListResultShape, ListShapeForType } from "./types";
...
declare global {
  export namespace PothosSchemaTypes {
    ...
    export interface UserSchemaTypes {
      ListWrapper: Record<string, unknown>;
    }
    ...
    export interface SchemaBuilder<Types extends SchemaTypes> {
      ...
      }) => ObjectRef<Types, ListShapeForType<Types, Type, NodeNullable>>;
    }
    ...
    > {
      ...
      >(
        options: FieldOptionsFromKind<
          ...
          Type,
          Nullable,
          InputFieldsFromShape<Types, ParentShape, "Arg">,
          Kind,
          ResolveShape,
          ResolveReturnShape
        > extends infer FieldOptions
          ? ListFieldOptions<
              ...
              FieldOptions extends {
                resolve?: (parent: infer P, ...args: unknown[]) => unknown;
              }
                ? P
          ...
          : never
      ) => FieldRef<ListShapeForType<Types, Type, Nullable> & SchemaTypes>;
    }
  }
}
